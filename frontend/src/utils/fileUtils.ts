 ...
 * how metrics are classified in the TokCollate backend
 */
...
/**
 * Load NPZ files generated by TokCollate and convert them to JSON
 */
...
/**
 * Load metadata from TokCollate Scorer output metadata file
 * Expected format:
 * {
 *   "dataset_name": "string",
...
/**
 * Load metrics and correlation data from a directory containing TokCollate output files
